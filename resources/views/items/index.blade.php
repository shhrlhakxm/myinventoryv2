                    ...
                    <table class="w-full text-sm text-left">
                        <thead class="bg-slate-50 text-slate-600 uppercase text-xs">
                            <tr>
                                ...
                                <th scope="col" class="whitespace-nowrap px-6 py-3">SKU</th>
                                <th scope="col" class="whitespace-nowrap px-6 py-3">Category</th>
                                <th scope="col" class="whitespace-nowrap px-6 py-3">Stock</th>
                                <th scope="col" class="whitespace-nowrap px-6 py-3">Unit Price</th>
                                <th scope="col" class="whitespace-nowrap px-6 py-3 text-right">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
